# Azure Enterprise Network Project: Multi-Region Deployment 
...
| [Architecture](#architecture) | Side by side comparison of both sites + Topology|
...
| [Scenario #3: New EU App Subnet](#scenario-3-new-eu-app-subnet-requested-by-the-network-manager) | Standing up a new isolated app subnet on request with Terraform |
